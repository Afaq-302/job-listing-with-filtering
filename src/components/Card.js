        ...
        <div className="Card-component relative  h-[120px] mx-32 my-8 bg-white rounded-lg shadow-lg px-6 py-3 overflow-hidden group">
            ...
            <div className="grid grid-cols-4">
                <div className=" col-span-2 gap-6 flex flex-row ">
                    ...
                    <div className="flex flex-col justify-center details-box ">
                        <div className="features-box flex gap-3">
                            <h4 className="text-[--dark-cyan] text-[14px] font-bold">Photosnap</h4>

                            <div className="flex flex-row items-center">
                                <span className="text-white rounded-lg bg-[--dark-cyan] py-[2px] px-[6px] text-[12px] font-semibold">NEW!</span>
                                <span className="text-white rounded-lg bg-black ml-2 py-[2px] px-[6px] text-[12px] font-semibold">FEATURED</span>
                            </div>
                        </div>
                        <h3 className="text-[#2a3533] font-bold text-[18px] my-1 cursor-pointer hover:text-[--dark-cyan]">Senior Frontend Developer</h3>
                ...
                <div className="tags-box col-span-2 flex flex-row-reverse items-center px-4 py-4">
                    <span class="font-semibold text-[--dark-cyan] px-2 py-1 bg-[--light-cyan] rounded-md mx-1 cursor-pointer hover:text-white hover:bg-[--dark-cyan]">Frontend</span>
                    <span class="font-semibold text-[--dark-cyan] px-2 py-1 bg-[--light-cyan] rounded-md mx-1 cursor-pointer hover:text-white hover:bg-[--dark-cyan]">JavaScript</span>
                    <span class="font-semibold text-[--dark-cyan] px-2 py-1 bg-[--light-cyan] rounded-md mx-1 cursor-pointer hover:text-white hover:bg-[--dark-cyan]">Python</span>
                </div>
            </div>
